            ...
            if ($.trim(key) != "") {
                switch (key) {
                    ...
                    case 'prompt-textarea':
                        bootbox.prompt({
                            title: 'Your Enquiry, Please provide contact number or Email',
                            inputType: 'textarea',
                            buttons: {
                                cancel: {
                                    label: '<i class="fa fa-times"></i> Cancel'
                    ...
                    case 'custom-dialog-init':
                        var dialog = bootbox.dialog({
                            title: 'Booking in progress, please wait',
                        ...
                        dialog.init(function () {
                            ...
                            setTimeout(function () {
                                dialog.find('.bootbox-body').html('Booking Successful, An email has been sent to you with booking details!');
                            }, 3000);
                        });
